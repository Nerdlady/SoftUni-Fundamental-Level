...
namespace Orders
{
    class Program
    {
        ...
        private static void PrintTheMostProfitableCategory(IEnumerable<Order.Order> orders, IEnumerable<Product> products, IEnumerable<Category> categories)
        {
            var category = orders
        ...
        private static void PrintTheMostOrderedProducts(IEnumerable<Order.Order> orders, IEnumerable<Product> products, int count)
        {
