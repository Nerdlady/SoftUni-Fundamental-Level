...
public static class StringExtensions
{
    ...
    /// <summary>
    /// Converts given string to short if it is possible.
    /// </summary>
    /// <param name="input">String to be convert to short</param>
    /// <returns>Short version of the given string or 0</returns>
    ...
    /// <summary>
    /// Converts given string to integer if it is possible.
    /// </summary>
    /// <param name="input">String to be convert to integer</param>
    /// <returns>Integer version of the given string or 0</returns>
    ...
    /// <summary>
    /// Converts given string to long if it is possible.
    /// </summary>
    /// <param name="input">String to be convert to long</param>
    /// <returns>Long version of the given string or 0</returns>
    ...
    /// <summary>
    /// Converts given string to DateTime if it is possible.
    /// </summary>
    /// <param name="input">String to be convert to DateTime</param>
    /// <returns>DateTime version of the given string or 0</returns>
    ...
    /// <summary>
    /// Convert all letters in given string from Cyrillic to Latin.
    /// </summary>
    /// <param name="input">String to be convert.</param>
    ...
    /// <summary>
    /// Convert all letters in given string from Latin to Cyrillic.
    /// </summary>
    /// <param name="input">String to be convert.</param>
    ...
    /// <summary>
    /// Validates given string if is properly converted to Cyrillic after replacing spaces with dashes.
    /// </summary>
    /// <param name="input">String to be validated.</param>
    /// <returns>Validated string with replaced/removed Latin chars.</returns>
    ...
    /// <summary>
    /// Gets first character in given string.
    /// </summary>
